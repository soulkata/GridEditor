...
namespace Assets.Grids
{
    ...
    public class GridMapBehavior : MonoBehaviour
    {
        ...
        {
            this.GetComponent<GridMapInitializerBehaviour>().InitializeMap(out this.xAmmount, out this.yAmmount, out this.floors, out this.verticalWalls, out this.horizontalWalls);
        }
